...
public class ConveyorCubeSpeedController
{
    ...
    private static readonly Color AheadColor = new(1f, 0.85f, 0.1f, 1f);
    private static readonly Color BoostColor = new(0.1f, 0.9f, 1f, 1f);
    private static readonly Color AnchorColor = new(1f, 0.35f, 0.2f, 1f);
    private static readonly Color BehindLockColor = new(1f, 0.25f, 0.8f, 1f);
    ...
    private bool CanDrawPickupRanges(SplineContainer splineContainer, List<CarrierBase> carriers)
    {
        return _boostConfig != null
               ...
               && splineContainer.Spline is { Count: > 0 }
               && carriers != null;
    }
