...
public class ConveyorSpawnPointCalculator
{
    ...
    public Vector3 GetDeliverySpawnPosition(float progress, int index)
    {
        ...
        if (_splineContainer == null || _splineContainer.Spline is not { Count: > 0 })
        {
            return center;
        }
    ...
    private Vector2 GetDeliveryPatternOffset(int index)
    {
        ...
        {
            1 => new Vector2(_deliverySideSpread, 0f),
            2 => new Vector2(-_deliverySideSpread, 0f),
            3 => new Vector2(0f, _deliveryForwardSpread),
            4 => new Vector2(0f, -_deliveryForwardSpread),
            _ => Vector2.zero
        };
    }
