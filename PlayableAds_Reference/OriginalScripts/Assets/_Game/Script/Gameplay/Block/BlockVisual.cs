...
public class BlockVisual : MonoBehaviour
{
    ...
    private Block ParentBlock => _parentBlock ??= GetComponent<Block>();
    ...
    private void PlayHiddenRevealVfx()
    {
        ...
        ReturnHiddenRevealVfxToPool(spawnedVfx).Forget();
    }

    private async UniTaskVoid ReturnHiddenRevealVfxToPool(ParticleSystem spawnedVfx)
    {
