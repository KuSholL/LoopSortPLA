...
{
    private readonly Dictionary<GameObject, Queue<GameObject>> _prefabToPool = new();
    ...
    public T PopFromPool<T>(T prefab, Transform parent = null) where T : Component
    {
        ...
        var instance = PopObject(prefab.gameObject, parent);
    ...
    public void PushToPool<T>(T instance) where T : Component
    {
        ...
        var prefab = _instanceToPrefab[instanceObject];
    ...
    private GameObject PopObject(GameObject prefab, Transform parent)
    {
        ...
        var instance = TryDequeue(prefab) ?? CreateInstance(prefab);
