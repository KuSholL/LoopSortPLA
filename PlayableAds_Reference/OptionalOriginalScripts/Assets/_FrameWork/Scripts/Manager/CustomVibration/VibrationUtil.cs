...
namespace VibrationUtility
{
    ...
    public class VibrationUtil
    {
        ...
        public static void Vibrate(VibrationType vibrationType, float intensity = 1.0f)
        {
            ...
            if (vibrationInstance != null) vibrationInstance.Vibrate(vibrationType, intensity);
        }
        ...
        public static void VibrateCustomized(long[] pattern, int[] amplitude)
        {
            ...
            if (vibrationInstance != null) vibrationInstance.VibrateCustom(pattern, amplitude);
        }
        ...
        public static void VibrateFor(long duration, int amplitude = 100)
        {
#if UNITY_ANDROID
            if (vibrationInstance != null) vibrationInstance.VibrateFor(duration, amplitude);
#elif UNITY_IOS
            if (duration <= 30) Vibrate(VibrationType.Soft);
            else if (duration <= 50) Vibrate(VibrationType.Medium);
            else if (duration <= 100) Vibrate(VibrationType.Heavy);
            else Vibrate(VibrationType.Default);
#endif
        }
