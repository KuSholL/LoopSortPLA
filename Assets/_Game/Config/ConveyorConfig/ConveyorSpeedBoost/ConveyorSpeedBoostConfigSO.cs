...
[CreateAssetMenu(
    fileName = "ConveyorSpeedBoostConfigSO",
    menuName = "ScriptableObjects/ConveyorSpeedBoostConfig")]
public class ConveyorSpeedBoostConfigSO : ScriptableObject
{
    ...
    [Range(-1f, 1f)] public float PostUnloadFreezeAroundOffset = 0f;

    [Tooltip("Hệ số tốc độ áp dụng cho các cube trong vùng quanh spawn trong lúc đang bị giảm tốc sau unload.")]
    [Range(0f, 1f)] public float PostUnloadFreezeSpeedMultiplier = 0.5f;
