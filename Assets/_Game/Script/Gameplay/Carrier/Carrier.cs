...
public class Carrier : CarrierBase
{
    ...
    protected override void OnDisable()
    {
        ...
        if (_linkedBlockVisualController != null) _linkedBlockVisualController.Reset();
        _mechanicContainer.Reset(this);
        if (_visualController != null) _visualController.Reset();
    ...
    public override void CreateBlocks(CarrierStackData carrierStack, bool suppressProgressAnimation = false)
    {
        ...
        if (_linkedBlockVisualController != null) _linkedBlockVisualController.Refresh(suppressProgressAnimation);
    }
    ...
    public override void FinishUnloadCarrier()
    {
        ...
        if (_linkedBlockVisualController != null) _linkedBlockVisualController.RefreshAfterUnload(revealedHiddenBlockIndex);
    }
        ...
        if (reservation.TargetBlock != null && reservation.TargetBlock.IsFull())
        {
            ...
            if (targetBlockIndex >= 0 && _linkedBlockVisualController != null)
            {
                if (_linkedBlockVisualController.CanBlockMergeWithNeighbors(targetBlockIndex))
                {
                    ...
                    if (SoundManager.Instance != null) SoundManager.Instance.PlayOneShot(AudioClipName.sfx_merge);
                }
            }

            if (_linkedBlockVisualController != null) _linkedBlockVisualController.RefreshAfterReceive(targetBlockIndex);
        }
    }
    ...
    public override void RefreshMechanicVisualState()
    {
        ...
        if (_visualController != null) _visualController.ApplyVisualRequest(visualRequest);
        if (_visualController != null) _visualController.SetSpecialColorTint(GetSpecialReceiverTintColor());
    }
    ...
    public override bool TryGetSpecialReceiverTargetColor(out EBlockColorType colorType)
    {
        foreach (var mechanic in _mechanicContainer.Mechanics)
        {
            var specialReceiver = mechanic as ISpecialColorReceiverMechanic;
            if (specialReceiver == null) continue;
    ...
    {
        if (blockLayout == null || blockLayout.Blocks == null) return false;
    ...
    {
        var topBlock = _blockController != null ? _blockController.GetTopUnloadCandidateBlock() : null;
    ...
    private Color? GetSpecialReceiverTintColor()
    {
        ...
        return colorEntry != null ? (Color?)colorEntry.Color : null;
    }
