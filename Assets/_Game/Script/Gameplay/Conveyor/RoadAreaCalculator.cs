...
public class RoadAreaCalculator : MonoBehaviour
{
    ...
    [SerializeField] private float roadArea;
    [SerializeField] private float objectFootprintArea;
    [SerializeField] private int recommendedObjectCount;
    [SerializeField] private int cubePerBlock;
    [SerializeField] private int blockPerCarrier;
    [SerializeField] private int requiredBlockCount;
    [SerializeField] private int requiredCarrierCount;
