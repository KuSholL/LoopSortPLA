...
[CreateAssetMenu(fileName = "ConveyorCornerDetectorConfigSO", menuName = "ScriptableObjects/ConveyorCornerDetectorConfig")]
public class ConveyorCornerDetectorConfigSO : ScriptableObject
{
	...
	[Range(0.01f, 5f)]
	public float GizmoHeight = 0.75f;
}
